...
| DEP-M5-06 | The simulation harness produces a CVaR99 estimate that models peak-picking and correlated identity waves | Wave 4 | The reserve is sized against a world where traders request at random, which they do not (OQ-M5-05) |
