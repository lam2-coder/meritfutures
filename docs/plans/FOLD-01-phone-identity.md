...
| [GOLDEN_SCENARIOS](../testing/golden-scenarios/README.md) | **CI-06d.** New scenarios continue from the registry's maximum in a new section, one per (a) to (e) plus amendments 2 and 3 plus the authority boundary. **Eight minimum** |
...
| [STATE](../STATE.md), [SESSION_LOG](../sessions/README.md) | The end ritual |
