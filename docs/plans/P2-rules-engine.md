...
|---|---|---|
| 272 golden scenarios exist | **<!--gen:gs_count-->304<!--/gen-->.** `GS-001` to `GS-284`, gapless | [golden-scenarios](../testing/golden-scenarios/README.md), sections 34 and 35 added `GS-258` to `GS-284` |
