...
| **HTTP methods the registry admits** | [`registry.ts:106`](../../apps/api/src/registry.ts) | **`['GET', 'POST', 'PATCH', 'PUT', 'DELETE']`**, and `compose` keys on `METHOD /path`. A socket upgrade is none of them |
