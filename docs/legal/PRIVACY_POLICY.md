---
status: approved
depends_on: [README.md, ../plans/M19-kyc-identity.md, ../plans/M07-risk-abuse.md, ../plans/M03-billing-checkout.md, ../decisions/README.md, ../architecture/SECURITY.md]
...
**Two mappings are explicitly flagged as counsel work and are not attempted here:** the **BIPA and state-biometric consent** analysis, and the **GDPR lawful-basis** mapping for each category below. Both are [counsel packet item 3](../decisions/gates/consolidated-founder-addendum-and-batch-2-gate-closure-2026-08-14.md).
