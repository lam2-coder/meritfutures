---
status: approved
depends_on: [../plans/M01-rules-engine.md, ../GLOSSARY.md, ../architecture/DATA_MODEL.md, ../EDGE_CASES.md, ../decisions/README.md]
...
| GS-240 to GS-242 | Scenarios created by [ADR-024](../decisions/ADR-024.md): the ladder and invitation separation, the shortened lifetime bound, percent-of-size scaling | M1, M18 |
| GS-243 to GS-245 | Scenarios created by [ADR-025](../decisions/ADR-025.md): bound invariance across loyalty state, perk exclusion under review, loyalty credit provenance | M14 |
