...
| **M6 admin and ops console** | GS-112 to GS-117, GS-130, GS-251, GS-279, GS-282, GS-284, GS-288 to GS-292, GS-296 to GS-304 | 25 |
...
| | | **<!--gen:gs_count-->304<!--/gen-->** |

**Numbering is contiguous from GS-001 to GS-304 with no gaps and no duplicates**, which CI-06d asserts on every push ([STRATEGY](../STRATEGY.md) section 4.4).
...
### 33.2 How the registry reached <!--gen:gs_count-->304<!--/gen-->
...
| **[FOLD-02](../../plans/FOLD-02-enforcement-window-and-suspension.md): the enforcement window and identity restriction** ([ADR-040](../../decisions/ADR-040.md), [ADR-041](../../decisions/ADR-041.md)) | GS-273 to GS-284 | 12 | **<!--gen:gs_count-->304<!--/gen-->** |
...
**The registry was quoted at 242 going into Wave 4 and stood at 257 leaving it**, and the three folds since have taken it to <!--gen:gs_count-->304<!--/gen-->. The fifteen are not scope creep: ten discharge an obligation [SECURITY](../../architecture/SECURITY.md) recorded for this wave, three carry a founder ruling, and two fix a collision in which one number answered to two fixtures.
...
| Section 5.2's minimum of 40 golden files | <!--gen:gs_count-->304<!--/gen--> defined | yes |
