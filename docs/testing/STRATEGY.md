...
**It is not wired into CI.** The reconciliation ruling was to take PR #7's `corpus.yml` unchanged, and adding a step is a change. The addition is three lines in the `integrity` job and is a founder call, not a session's.
