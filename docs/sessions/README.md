...
| [2026-08-20 - Session 111](2026-08-20-session-111.md) | WAVE-04 `W4`: the day fold and its boundaries. Four golden fixtures, `GS-047`, `GS-049`, `GS-059` and `GS-079`, every expected end state derived by hand from M01 under `TR-01` |
