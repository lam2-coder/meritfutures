...
| ~~**124**~~ | ~~[WAVE-05](../plans/WAVE-05-tier2-fixture-shapes.md) `X6`, `GS-030`'s surviving half in [`trading-calendar-generator.test.ts`](../../packages/db/test/trading-calendar-generator.test.ts)~~ | **WRITTEN.** Struck, and its entry is below |
