...
| **124** | [WAVE-05](../plans/WAVE-05-tier2-fixture-shapes.md) `X6`, `GS-030`'s surviving half in [`trading-calendar-generator.test.ts`](../../packages/db/test/trading-calendar-generator.test.ts) | **CLAIMED 2026-08-21.** Depends on nothing; `X7` depends on it |
...
| [2026-08-21 - Session 124](2026-08-21-session-124.md) | WAVE-05 `X6`: `GS-030`'s surviving half, IN FLIGHT |
