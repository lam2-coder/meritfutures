...
| **123** | [WAVE-05](../plans/WAVE-05-tier2-fixture-shapes.md) `X1`, the six comments naming the `GS-nnn` each assertion site discharges | dispatched, unwritten |
| **124** | WAVE-05 `X6`, `GS-030`'s surviving half in the calendar generator suite | dispatched, unwritten |
