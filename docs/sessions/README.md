...
| ~~**134**~~ | ~~`P2-b`, `replay` joins the rules engine's public surface (`ADR-078`). **MONEY PATH** ([P2 build plan](../plans/P2-rules-engine-build.md))~~ | **WRITTEN.** Struck, and its entry is below |
