...
| [EDGE_CASES.md](EDGE_CASES.md) | Living registry; every bug becomes an entry plus a golden file (56 entries; EC-001 to EC-050 approved with M01, EC-051+ under review with their module) | approved | founder |
...
| [GOLDEN_SCENARIOS.md](testing/GOLDEN_SCENARIOS.md) | Every B4 scenario plus inventions, numbered (93 defined; GS-001 to GS-083 approved with M01, GS-084+ under review with their module) | approved | founder |
