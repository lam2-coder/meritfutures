...
**<!--gen:adr_count-->45<!--/gen--> ADRs. <!--gen:ec_count-->149<!--/gen--> edge cases. <!--gen:gs_count-->272<!--/gen--> golden scenarios. Four waves.** These are generated spans under [CI-06g](testing/STRATEGY.md); this line read "25 ADRs" until it was folded, which is the drift [ADR-034](decisions/ADR-034.md) exists to end.
