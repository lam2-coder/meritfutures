...
| **CI-01, CI-02, CI-04, CI-05, CI-07 to CI-09** | **NOT STARTED** | `.github/workflows/` holds two files, `corpus.yml` and `golden.yml`. Lint and types, unit and property, integration, security static, build checks, E2E and the nightly do not exist |
