...
4. **Batch 2 raises four decisions of its own**, listed under "Gate in front of us" and detailed in each plan's section 10. Two are counsel questions ([M18](plans/M18-live-graduation-pipeline.md) OQ-M18-01 on the live program, [M20](plans/M20-wallet.md) OQ-M20-03 on payable versus stored value) and should go to counsel together with the wallet item [ADR-019](DECISIONS.md) already flagged and the escheatment mapping in [M20](plans/M20-wallet.md) OQ-M20-04.
