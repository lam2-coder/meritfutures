...
| [ADR-086](ADR-086.md) | The job interface is five methods, the transaction is the first argument, and one primitive is foreclosed on purpose  (2026-08-24, status: proposed) |
