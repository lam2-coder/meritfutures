...
| **044** | `claude/builder-reviewer-loop-rykvhs`, this session | **written on the branch, unmerged.** [ADR-044](ADR-044.md), the `trading_calendar` prior image becomes a trigger. [ADR-042](ADR-042.md) was silent and the founder has ruled it |
