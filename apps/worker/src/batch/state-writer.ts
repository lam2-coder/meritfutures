...
//   `engine_gates`   NOT DECLARED, AND NOT DECLARABLE HERE. `EngineGateResults`
//                    types four of its twenty-five leaves as `Cents`, which is
...
//                    gates where the engine produces six. So no primary source
//                    says what goes in the column.
//
