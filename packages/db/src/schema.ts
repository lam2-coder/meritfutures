...
// =============================================================================
// EIGHTY-SEVEN TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 24 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE EIGHTY-SEVEN ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the eighty-seven below carry later columns -- `sessions`, `plan_versions`,
