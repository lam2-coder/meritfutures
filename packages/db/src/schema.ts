...
// =============================================================================
// SIXTY-FIVE TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 46 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE SIXTY-FIVE ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the sixty-five below carry later columns -- `sessions`, `plan_versions`,
