...
// =============================================================================
// NINETY TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 21 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE NINETY ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the ninety below carry later columns -- `sessions`, `plan_versions`,
