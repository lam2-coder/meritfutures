...
// =============================================================================
// SIXTY TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 51 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE SIXTY ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the sixty below carry later columns -- `sessions`, `plan_versions`,
