...
// =============================================================================
// EIGHTY-THREE TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 28 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE EIGHTY-THREE ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the eighty-three below carry later columns -- `sessions`, `plan_versions`,
