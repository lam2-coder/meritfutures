...
// =============================================================================
// NINETY-ONE TABLES OF 111, AND THAT IS REPORTED RATHER THAN ROUNDED UP. The
// other 20 are not reachable through either accessor: `SCOPE_RULES` is total
...
//
// THE NINETY-ONE ARE NOT ONE PHASE'S SET AND WILL NEVER BE. ADR-092 makes the
...
// of the ninety-one below carry later columns -- `sessions`, `plan_versions`,
