...
describe('the registry is total', () => {
  ...
  // rounded up: the other 51 are unreachable through either accessor.
  //
  // `identity_links` IS ONE OF THE 51 AND ITS ABSENCE IS DELIBERATE. It carries
  ...
  test('60 declared tables, 60 scope rules, 0 reachable without one', () => {
