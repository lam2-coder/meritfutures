...
describe('the registry is total', () => {
  ...
  // rounded up: the other 43 are unreachable through either accessor.
  //
  ...
  test('68 declared tables, 68 scope rules, 0 reachable without one', () => {
    ...
    expect(declared).toBe(68);
    expect(rules).toBe(68);
