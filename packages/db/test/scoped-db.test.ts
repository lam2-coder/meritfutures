...
describe('the registry is total', () => {
  ...
  // rounded up: the other 46 are unreachable through either accessor.
  //
  // `identity_links` IS ONE OF THE 46 AND ITS ABSENCE IS DELIBERATE. It carries
  ...
  test('65 declared tables, 65 scope rules, 0 reachable without one', () => {
    ...
    expect(declared).toBe(65);
    expect(rules).toBe(65);
