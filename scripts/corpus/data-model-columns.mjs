...
//    `gates.mjs:9429` reads `export const GATES = [`, and `:9635` opens the
//    guard `const invokedDirectly = ...` closed at `:9638` by
...
//    this header was written, and the same file also exports `EXIT` at `:9513`
//    and `runGates` at `:9538`. So the duplication below is now a DEFERRAL WITH
