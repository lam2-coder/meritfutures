...
- **Data types:** L1 + full L2 market depth, futures and equities, real-time + historical. No account/fill data — not an ingest source.
...
- **Data types:** NinjaTrader as a front-end connects through Rithmic/CQG/Tradovate feeds ([crosstrade NT8 prop guide](https://crosstrade.io/blog/ninjatrader-8-prop-firm-connection-guide)); when traders use NinjaTrader-on-Rithmic, all fills still land in Rithmic's admin surface — no separate ingest needed.
